...
system_prompt = (
    "You are an helpful assistant called Mathstral, you are an expert at Math and Reasoning."
)
...
def create_gradio_app(
    ...
    demo = gr.ChatInterface(
        generate, title="Chat with Mistral Mathstral", chatbot=gr.Chatbot(layout="panel")
    )
